...
plotter.setup_file("lks_normal.ini",x_column=0,y_column=1,y_err_types=["percentage","digit"],y_err_setting=[1.5,10],x_err_types=["plain"],x_err_setting=[2])
plotter.setup_file("lks_parallel.ini",x_column=0,y_column=1,y_err_types=["percentage","digit"],y_err_setting=[1.5,10],x_err_types=["plain"],x_err_setting=[2])
plotter.redefine_y("lks_normal.ini","lks_normal_u0.ini",0,calc_R,gauss_propagation,uncert_types=["percentage","digit"],uncert_settings=[1.5,10])
plotter.redefine_y("lks_parallel.ini","lks_parallel_u0.ini",0,calc_R,gauss_propagation,uncert_types=["percentage","digit"],uncert_settings=[1.5,10])

#plotter.err_plot(["flo_normal.ini","flo_parallel.ini"],y_label="$\\sqrt{\\frac{U_{\\alpha}}{U_0}}$",x_label="$\\alpha \\ in \\ °$")
plotter.fit_plot(["lks_normal.ini","lks_parallel.ini"],[RS,RP],[1,2],["r","b"],override_start=[[0.1],[0.5,0.5]],
                legends_fit=["Senkrechte Polarisation - Fitfunktion","Parallele Polarisation - Fitfunktion"],
                x_label="$\\alpha \\ in \\ °$", y_label="$\\sqrt{\\frac{U_r(\\alpha)}{U_0}}$", title="$Messergebnisse \\ und \\ Regression_{lks}$",show=False)
plotter.describe()
